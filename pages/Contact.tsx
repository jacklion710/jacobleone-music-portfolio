    ...
    return (
      <ChakraProvider>
        ...
        <Flex 
            ...
            color="white"
        >
        <motion.div ref={navRef} initial="hidden" animate={navInView ? "visible" : "hidden"} variants={fadeIn}>
          <Navbar />
        </motion.div>
        <Flex direction="column" align="center" justify="flex-start" py={8} px={4} flexGrow={1} overflowY="auto">
          <Box w="100%" maxW="600px" textAlign="center" position="relative">
            <motion.div ref={ref} initial="hidden" animate={inView ? "visible" : "hidden"} variants={fadeIn}>
              <Heading size="2xl" mb={4} position="relative" textShadow="0 0 5px red, 0 0 10px red, 0 0 15px red, 0 0 20px teal" color="white">
                Connect
              </Heading>
            ...
            <form onSubmit={handleSubmit}>
              <Flex wrap="wrap" justifyContent="space-between" color={'white'}>
                <FormControl id="name" mb={4} flex="1" mr={2}>
                  <FormLabel>Name</FormLabel>
                  <Input ref={nameRef} type="text" required bg="white" borderColor="black" color="black"/>
                </FormControl>
                <FormControl id="lastName" mb={4} flex="1" ml={2}>
                  <FormLabel>Last Name</FormLabel>
                  <Input ref={lastNameRef} type="text" required bg="white" borderColor="black" color="black"/>
                </FormControl>
              </Flex>
              <FormControl id="email" mb={4} color={'white'}>
                <FormLabel>Email</FormLabel>
                <Input ref={emailRef} type="email" required bg="white" borderColor="black" color="black"/>
              </FormControl>
              <FormControl id="subject" mb={4} color={'white'}>
                <FormLabel>Subject</FormLabel>
                <Input ref={subjectRef} type="text" required bg="white" borderColor="black" color="black"/>
              </FormControl>
              <FormControl id="message" mb={4} color={'white'}>
                  <FormLabel>Message</FormLabel>
                  <Textarea ref={messageRef} rows={4} required bg="white" borderColor="black" color="black"/>
                </FormControl>
              <Button type="submit" colorScheme="red" mb={4}>
                Submit
              </Button>
            </form>
            </motion.div>
