      ...
      >
          ...
          >
              ...
              <SimpleGrid columns={[1, 2, 3]} spacing={10} w="full">
                  ...
                  <Box key={index} p={5} borderWidth="1px" borderRadius="md" borderColor={borderColor} shadow="lg" transition="transform .2s" _hover={{ transform: 'scale(1.05)' }} bgColor="rgba(0, 0, 0, 0.75)"
                  >
